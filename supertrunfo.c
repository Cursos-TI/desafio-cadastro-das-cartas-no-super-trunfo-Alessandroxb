...
//DECLARAÇÃO DE DADOS DA PRIMEIRA CARTA
    ...
    printf("Informe a letra(A até G): ");
    scanf(" %c", &estado1);
    ...
    scanf(" %[^\n]", cidade1); 
// " %[^\n]" Lê string com espaço ex:"Espírito Santo" aprendido com ChatGPT
...
// DECLARAÇÃO DE DADOS DA SEGUNDA CARTA

    printf("\nAgora cadastre os dados da CARTA 2:\n");

    printf("Informe a letra(A até H): ");
    scanf(" %c", &estado2);
